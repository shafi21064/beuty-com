...
import 'package:kirei/screens/recomendation_pages/screeen/acne/recomedation_screen_acne_four.dart';
import 'package:kirei/screens/recomendation_pages/screeen/acne/recomedation_screen_acne_three.dart';
...
class RecomendationScreenAcneTwo extends StatefulWidget {
  const RecomendationScreenAcneTwo({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenAcneTwo> createState() => _RecomendationScreenAcneTwoState();
}

class _RecomendationScreenAcneTwoState extends State<RecomendationScreenAcneTwo> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[1].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[1].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[1].options[index],
                          selectedAns: index);
                    }),
                Padding(
        ...
        builder: (context, provider, child) {
          return InkWell(
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenAcneThree()));
            },
            child: Container(
