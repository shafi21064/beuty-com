...
import 'package:kirei/screens/recomendation_pages/screeen/acne/recomedation_screen_acne_five.dart';
...
class RecomendationScreenAcneFour extends StatefulWidget {
  const RecomendationScreenAcneFour({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenAcneFour> createState() => _RecomendationScreenAcneFourState();
}

class _RecomendationScreenAcneFourState extends State<RecomendationScreenAcneFour> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[3].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[3].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[3].options[index],
                          selectedAns: index);
                    }),
                Padding(
        ...
        builder: (context, provider, child) {
          return InkWell(
            onTap: () {
              ...
              provider.acneFourSelected = String.fromCharCode(65 + selectedValue).toLowerCase();
              print(provider.acneFourSelected);
              Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenAcneFive()));
            },
            child: Container(
