...
class RecomendationScreenAcneFive extends StatefulWidget {
  const RecomendationScreenAcneFive({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenAcneFive> createState() => _RecomendationScreenAcneFiveState();
}

class _RecomendationScreenAcneFiveState extends State<RecomendationScreenAcneFive> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[4].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[4].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[4].options[index],
                          selectedAns: index);
                    }),
                Padding(
