...
class RecomendationScreenAcne extends StatefulWidget {
  const RecomendationScreenAcne({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenAcne> createState() => _RecomendationScreenAcneState();
}

class _RecomendationScreenAcneState extends State<RecomendationScreenAcne> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[0].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[0].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[0].options[index],
                          selectedAns: index);
                    }),
                Padding(
