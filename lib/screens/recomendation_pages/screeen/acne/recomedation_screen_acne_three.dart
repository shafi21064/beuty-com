...
class RecomendationScreenAcneThree extends StatefulWidget {
  const RecomendationScreenAcneThree({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenAcneThree> createState() => _RecomendationScreenAcneThreeState();
}

class _RecomendationScreenAcneThreeState extends State<RecomendationScreenAcneThree> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[2].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[2].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['acne'].questions[2].options[index],
                          selectedAns: index);
                    }),
                Padding(
