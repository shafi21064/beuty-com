...
class RecomendationScreendehydredTwo extends StatefulWidget {
  const RecomendationScreendehydredTwo({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreendehydredTwo> createState() => _RecomendationScreendehydredTwoState();
}

class _RecomendationScreendehydredTwoState extends State<RecomendationScreendehydredTwo> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns["dehydrated_skin"].questions[1].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns["dehydrated_skin"].questions[1].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns["dehydrated_skin"].questions[1].options[index],
                          selectedAns: index);
                    }),
                Padding(
        ...
        builder: (context, provider, child) {
          return InkWell(
            onTap: () async{
              ...
              provider.dehydredTwoSelected = String.fromCharCode(65 + selectedValue).toLowerCase();
              print(provider.dehydredTwoSelected);
