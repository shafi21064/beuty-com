...
import 'recomedation_screen_goal_two.dart';

class RecomendationScreenGoalOne extends StatefulWidget {
  const RecomendationScreenGoalOne({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenGoalOne> createState() => _RecomendationScreenGoalOneState();
}

class _RecomendationScreenGoalOneState extends State<RecomendationScreenGoalOne> {
        ...
        builder: (context, provider, child) {
          return InkWell(
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => RecomendationScreenGoalTwo()));
            },
            child: Container(
