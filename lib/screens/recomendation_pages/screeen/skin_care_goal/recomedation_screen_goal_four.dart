...
import 'package:kirei/screens/recomendation_pages/screeen/skin_care_goal/recomedation_screen_goal_five.dart';
...
class RecomendationScreenGoalFour extends StatefulWidget {
  const RecomendationScreenGoalFour({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenGoalFour> createState() => _RecomendationScreenGoalFourState();
}

class _RecomendationScreenGoalFourState extends State<RecomendationScreenGoalFour> {
  int selectedValue;
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenGoalFive()));
          provider.afterShower = String.fromCharCode(65 + selectedValue).toLowerCase();
          print(provider.afterShower);
        },
        child: Container(
