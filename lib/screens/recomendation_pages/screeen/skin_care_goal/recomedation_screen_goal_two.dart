...
import 'package:kirei/screens/recomendation_pages/screeen/skin_care_goal/recomedation_screen_goal_three.dart';
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenGoalThree()));
