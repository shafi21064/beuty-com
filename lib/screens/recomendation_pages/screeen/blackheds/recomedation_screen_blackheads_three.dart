...
class RecomendationScreenBlackHeadsThree extends StatefulWidget {
  const RecomendationScreenBlackHeadsThree({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenBlackHeadsThree> createState() => _RecomendationScreenBlackHeadsThreeState();
}

class _RecomendationScreenBlackHeadsThreeState extends State<RecomendationScreenBlackHeadsThree> {
  int selectedValue;
            ...
            return ListView(
              ...
              children: [
                  ...
                  child: Center(
                      child: Text(
                        RecommendationController()
                            .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['blackheads_whiteheads'].questions[2].question,
                ...
                ListView.builder(
                    ...
                    .questions.relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['blackheads_whiteheads'].questions[2].options.length,
                    itemBuilder: (BuildContext context, int index) {
                      return buildQuestionContainer(
                          ansText: RecommendationController()
                              .questions
                              .relatedQuestionsBasedOnPrimaryConcern.primaryConcerns['blackheads_whiteheads'].questions[2].options[index],
                          selectedAns: index);
                    }),
                Padding(
