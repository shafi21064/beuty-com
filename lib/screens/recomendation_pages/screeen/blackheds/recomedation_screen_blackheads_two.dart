...
class RecomendationScreenBlackHeadsTwo extends StatefulWidget {
  const RecomendationScreenBlackHeadsTwo({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenBlackHeadsTwo> createState() => _RecomendationScreenBlackHeadsTwoState();
}

class _RecomendationScreenBlackHeadsTwoState extends State<RecomendationScreenBlackHeadsTwo> {
  int selectedValue;
        ...
        builder: (context, provider, child) {
          return InkWell(
            onTap: () {
              ...
              print(provider.blackHeadsTwoSelected);
