...
import 'recomedation_screen_six.dart';

class RecomendationScreenFive extends StatefulWidget {
  const RecomendationScreenFive({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenFive> createState() => _RecomendationScreenFiveState();
}

class _RecomendationScreenFiveState extends State<RecomendationScreenFive> {
  int selectedValue;
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          provider.selectedBasicSkinCare = String.fromCharCode(65 + selectedValue).toLowerCase();
          print(provider.selectedBasicSkinCare);
          Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenSix()));
        },
        child: Container(
