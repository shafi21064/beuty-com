...
class RecomendationScreenTwo extends StatefulWidget {
  const RecomendationScreenTwo({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenTwo> createState() => _RecomendationScreenTwoState();
}

class _RecomendationScreenTwoState extends State<RecomendationScreenTwo> {
  int selectedValue;
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          provider.selectedGender = String.fromCharCode(65 + selectedValue).toLowerCase();
          print(provider.selectedGender);
          Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenAllergic()));
        },
        child: Container(
