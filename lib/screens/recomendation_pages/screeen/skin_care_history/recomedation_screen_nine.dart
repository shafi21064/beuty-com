...
import '../skin_care_goal/recomedation_screen_goal_one.dart';

class RecomendationScreenNine extends StatefulWidget {
  const RecomendationScreenNine({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenNine> createState() => _RecomendationScreenNineState();
}

class _RecomendationScreenNineState extends State<RecomendationScreenNine> {
  int selectedValue;
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          provider.selectedSkinIrritate = String.fromCharCode(65 + selectedValue).toLowerCase();
          print(provider.selectedSkinIrritate);
          Navigator.push(context, MaterialPageRoute(builder: (_)=> RecomendationScreenGoalOne()));
        },
        child: Container(
