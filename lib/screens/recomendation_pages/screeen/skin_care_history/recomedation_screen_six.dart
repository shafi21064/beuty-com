...
import 'recomedation_screen_seven.dart';
    ...
    return Consumer<RecommendationController>(
      ...
      return InkWell(
        onTap: () {
          ...
          provider.selectedFollowingSkinCare = String.fromCharCode(65 + selectedValue).toLowerCase();
          print(provider.selectedFollowingSkinCare);
