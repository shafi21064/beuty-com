...
class RecomendationScreenFour extends StatefulWidget {
  const RecomendationScreenFour({
    Key key,
  }) : super(key: key);

  @override
  State<RecomendationScreenFour> createState() => _RecomendationScreenFourState();
}

class _RecomendationScreenFourState extends State<RecomendationScreenFour> {
  int selectedValue;
