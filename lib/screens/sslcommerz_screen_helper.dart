...
class SslCommerzScreenHelper extends StatefulWidget {
  double amount;
  String payment_type;
  ...
  @override
  _SslCommerzScreenHelperState createState() => _SslCommerzScreenHelperState();
}

class _SslCommerzScreenHelperState extends State<SslCommerzScreenHelper> {
