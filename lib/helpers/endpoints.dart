...
class ENDP{
  ...
  static const UpdateShipAddr = "${AppConfig.BASE_URL}/user/shipping/update-location";
  ...
  static const CountryList = "${AppConfig.BASE_URL}/countries";
  static const ShippingCost = "${AppConfig.BASE_URL}/shipping_cost";
  static const AddrUpdateInCart = "${AppConfig.BASE_URL}/update-address-in-cart";
  //Brand Repo
  static const FILTER_PAGE_BRANDS = "${AppConfig.BASE_URL}/filter/brands";
  ...
  static const GET_FEATURED_CATEGORIES= "${AppConfig.BASE_URL}/categories/featured";
  static const TOP_CATEGORIES= "${AppConfig.BASE_URL}/categories/top";
  static const FILTER_CATEGORIES= "${AppConfig.BASE_URL}/filter/categoriesp";

  //Chat repo..
  static const GET_CONVERSATION= "${AppConfig.BASE_URL}/chat/conversations?page=";
  ...
  static const CREATE_CONVERSATION= "${AppConfig.BASE_URL}/chat/create-conversation";
  //CLUB_POINT

  static const CLUB_POINT= "${AppConfig.BASE_URL}/clubpoint/get-list?page=";
  static const CLUB_POINT_WALLET= "${AppConfig.BASE_URL}/clubpoint/convert-into-wallet";
  //COUPON
  ...
  static const COMMUNITY_POST_CREATE = "${AppConfig.BASE_URL_1}/community-post-create";
  static const COMMUNITY_POST_COMMENT_CREATE = "${AppConfig.BASE_URL_1}/community-comment-create";
  static const COMMUNITY_POST_LIKE_CREATE = "${AppConfig.BASE_URL_1}/community-like-update";
  static const COMMUNITY_POST_COMMENT = "${AppConfig.BASE_URL_1}/community-comments";
  ...
  static const OFFLINE_RECHARGE = "${AppConfig.BASE_URL}/wallet/offline-recharge";
  //ORDER REPO
  static const PURCHASE_HISTORY = "${AppConfig.BASE_URL}/purchase-history";
  static const PURCHASE_HISTORY_DETAILS = "${AppConfig.BASE_URL}/purchase-history-details/";
  static const PURCHASE_HISTORY_ITEM = "${AppConfig.BASE_URL}/purchase-history-items/";
